...
```{r}
#Addinf lables
label(yrbss2019_project$age)<-"Age (years)"
label(yrbss2019_project$gender)<-"Sex"
label(yrbss2019_project$race)<-"Race"
label(yrbss2019_project$PA)<-"Physical Activity"
label(yrbss2019_project$mus_stren)<-"Muscle Strengthening"
label(yrbss2019_project$obese_new)<-"Obese"
label(yrbss2019_project$overweight_new)<-"Overweight"

table1(~age + gender + race+ PA + mus_stren + obese_new + overweight_new |sleep_deprive, overall="Total",  rowlabelhead="Variable", footnote='SD = standard deviation', yrbss2019_project)
```

# Table 1 Interpretation
###Age: A higher percentage of those who were not sleep deprived were among 15 years old than those who were sleep deprived(24.3 vs 28.8%). The opposite pattern was observed for those who were 17 years old with a lower percentage reported with no deprived sleep vs having deprived sleep (18.1% vs 24.0%).

###Gender: A higher percentage of individuals who were sleep deprived were females than those who were not sleep deprived (52.1% vs 46.2%). The opposite pattern was observed for males with a lower percentage reported with deprived sleep vs not having deprived sleep (46.8% vs 52.9%).

###Race: A higher percentage of those who were sleep deprived were Asian than those who were not deprived (4.9% vs 3.4%). The opposite pattern was observed for Non-Hispanic Whites with a lower percentage being reported as sleep deprived vs.not deprived (48.7% vs 52.5%).

###Grades: A higher percentage of those who were sleep deprived were 11th grade & 12th grade vs. those who reported not deprived (25.2%, 22.7% vs 21.0%, 15.7%). Conversely, a higher percentage of those with no deprived sleep at 10th grade vs those have deprived sleep (28.8% vs 26.6%)


# Unajusted Logistic model for Physical activity
```{r}
#logistic model with bmi as a predictor
PA_Logit <- glm(sleep_deprive ~ PA, data=yrbss2019_project, family="binomial")
summary(PA_Logit)
...
```
Interpretation
Based on the unajusted model results:
The odds of having deprived sleep for participants with who participated in 7 days of physical activity a week are 48% less likelly the odds than those who do not participated in physical activity in a week. 

The odds of having deprived sleep for participants with who participated in 6 days of physical activity a week are 37% less likelly the odds than those who do not participated in physical activity in a week. 

The odds of having deprived sleep for participants with who participated in 5 days of physical activity a week are 27% less likelly the odds than those who do not participated in physical activity in a week. 

The odds of having deprived sleep for participants with who participated in 4 days of physical activity a week are 22% less likelly the odds than those who do not participated in physical activity in a week. 

The odds of having deprived sleep for participants with who participated in 3 days of physical activity a week are 16% less likelly the odds than those who do not participated in physical activity in a week. 

The odds of having deprived sleep for participants with who participated in 2 days of physical activity a week are 16% less likelly the odds than those who do not participated in physical activity in a week. 
...
PALogit_multi <- glm(sleep_deprive ~ age + gender +race + PA, data=yrbss2019_project, family="binomial")
...
```{r}
#income and bmi cat logistic model
MULogit <- glm(sleep_deprive ~ mus_stren, data=yrbss2019_project, family="binomial")
summary(MULogit)
...
```{r}
#income and bmi cat logistic model
MULogit_multi <- glm(sleep_deprive ~ age + gender +race + mus_stren, data=yrbss2019_project, family="binomial")
...
```{r}
Slp_PA_OBEM<- glm(sleep_deprive ~ PA+obese_new+(PA*obese_new)+overweight_new+(PA*overweight_new), data=yrbss2019_project, family="binomial")
Slp_PA_OBLogit<-glm(sleep_deprive ~ PA+obese_new+overweight_new, data=yrbss2019_project, family="binomial")
#likilihood ratio test: compare two  models
lrtest(Slp_PA_OBEM, Slp_PA_OBLogit)

Slp_PA_ObeEM<- glm(sleep_deprive ~ PA+obese_new+(PA*obese_new), data=yrbss2019_project, family="binomial")
Slp_PA_ObeLogit<-glm(sleep_deprive ~ PA+obese_new, data=yrbss2019_project, family="binomial")
#likilihood ratio test: compare two  models
lrtest(Slp_PA_OBEM, Slp_PA_ObeLogit)

Slp_PA_OEM<- glm(sleep_deprive ~ PA+overweight_new+(PA*overweight_new), data=yrbss2019_project, family="binomial")
Slp_PA_OLogit<-glm(sleep_deprive ~ PA+overweight_new, data=yrbss2019_project, family="binomial")
#likilihood ratio test: compare two  models
